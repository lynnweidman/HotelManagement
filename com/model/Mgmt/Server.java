...
public class Server<E> extends RestaurantEmployee {
    ...
    public Server(int employeeId, String employeeFirstName, String employeeLastName, int salary, int yearHired, int serverId, int orderId) {
        super(employeeId, employeeFirstName, employeeLastName, salary, yearHired);
